 ...
 */
class Version20180124204510 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE tbl_slider (slider_id INT AUTO_INCREMENT NOT NULL, slide_name VARCHAR(255) NOT NULL, caption_1 VARCHAR(255) NOT NULL, caption_2 VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(slider_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
