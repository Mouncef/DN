 ...
 */
class Version20180128162016 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE dn_tbl_slider ADD slide_video_name VARCHAR(255) DEFAULT NULL, CHANGE slide_name slide_name VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE dn_tbl_slider DROP slide_video_name, CHANGE slide_name slide_name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
